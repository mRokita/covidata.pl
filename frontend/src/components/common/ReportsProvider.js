            ...
            <Box boxShadow={5} style={{position: 'fixed', bottom: 0, width: '100%'}}>
                <BottomNavigation
                    ...
                    <BottomNavigationAction label="Polska"
                                            value={"local"}
                                            icon={<img
                                                src="https://cdnjs.cloudflare.com/ajax/libs/emojione/2.2.7/assets/png/1f1f5-1f1f1.png"
                                                style={{height: 30, fontSize: '26px', marginBottom: 3}} alt="🇵🇱"/>}/>
                    <BottomNavigationAction label="Świat"
                                            value={"global"}
                                            icon={<img src="https://twemoji.maxcdn.com/2/72x72/1f30d.png"
                                                       style={{height: 30, fontSize: '25px', marginBottom: 3}}
                                                       alt={"🌍"}/>}/>
                </BottomNavigation>
            </Box>
        </React.Fragment>
